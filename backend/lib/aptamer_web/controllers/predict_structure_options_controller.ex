defmodule AptamerWeb.PredictStructureOptionsController do
  ...
  def index(conn, params) do
    predict_structure_options =
      case params do
        ...
        _ ->
          Repo.all(PredictStructureOptions)
      end
  ...
  def create(conn, %{
        "data" =>
          data = %{
            ...
            "attributes" => _predict_structure_options_params
          }
      }) do
    changeset =
      PredictStructureOptions.changeset(%PredictStructureOptions{}, Params.to_attributes(data))
    ...
    case Repo.insert(changeset) do
      {:ok, predict_structure_options} ->
        ...
        |> put_resp_header(
          "location",
          Routes.predict_structure_options_path(conn, :show, predict_structure_options)
        )
  ...
  def update(conn, %{
    ...
    changeset =
      PredictStructureOptions.changeset(predict_structure_options, Params.to_attributes(data))
